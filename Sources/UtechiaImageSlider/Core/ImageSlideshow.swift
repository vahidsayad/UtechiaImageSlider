...
public protocol ImageSlideshowDelegate: AnyObject {
    ...
    @objc optional func singleTapped(_ imageSlideshow: ImageSlideshow)
}
...
open class ImageSlideshow: UIView {
    ...
    func reloadScrollView() {
        ...
        for image in scrollViewImages {
            let item = ImageSlideshowItem(image: image, zoomEnabled: zoomEnabled, activityIndicator: activityIndicator?.create(), maximumScale: maximumScale, singleTapped: {
                self.delegate?.singleTapped?(self)
            })
