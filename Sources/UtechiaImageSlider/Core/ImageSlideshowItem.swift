...
open class ImageSlideshowItem: UIScrollView, UIScrollViewDelegate {
    ...
    */
    init(image: InputSource, zoomEnabled: Bool, activityIndicator: ActivityIndicatorView? = nil, maximumScale: CGFloat = 2.0, singleTapped: (() -> Void)?) {
        self.zoomEnabled = zoomEnabled
        self.image = image
        self.activityIndicator = activityIndicator
        self.maximumScale = maximumScale
        self.singleTap = singleTapped
        ...
        singleTapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(oneTapped))
        singleTapGestureRecognizer!.numberOfTapsRequired = 1
        singleTapGestureRecognizer!.isEnabled = true
        singleTapGestureRecognizer!.require(toFail: gestureRecognizer!)
